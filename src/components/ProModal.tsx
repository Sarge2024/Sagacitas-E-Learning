  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-xl bg-[#171f33] border border-white/20 rounded-[32px] p-8 shadow-2xs relative text-[#dae2fd] overflow-hidden"
      >
        <button
          id="close-pro-modal-btn"
          onClick={onClose}
          className="absolute top-6 right-6 text-[#c7c4d7] hover:text-white p-2 rounded-md hover:bg-white/10 transition-colors"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        {subscribed ? (
          <div className="py-12 text-center space-y-4">
            <div className="w-16 h-16 bg-[#2fd9f4]/20 rounded-md flex items-center justify-center text-[#2fd9f4] mx-auto animate-bounce">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-[#8083ff]/20 text-[#8083ff] rounded-md">
            ...
            {/* Billing Toggle */}
            <div className="flex items-center justify-center gap-4 bg-white/5 p-1.5 rounded-md border border-white/10 w-fit mx-auto text-xs font-bold">
              <button
              ...
              >
                ...
                <span className="bg-[#8083ff] text-[#0d0096] text-[9px] px-2 py-0.5 rounded-md uppercase">
                  Economize 33%
                </span>
              </button>
            </div>
            ...
            <button
              ...
              className="w-full py-4 bg-[#8083ff] hover:bg-[#6c70ff] text-[#0d0096] rounded-md font-extrabold text-sm uppercase tracking-wider transition-all shadow-[0_0_25px_rgba(128,131,255,0.4)] active:scale-95 flex items-center justify-center gap-2 mt-4 cursor-pointer"
            >
