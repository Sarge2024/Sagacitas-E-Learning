    ...
    >
      ...
      <div className={`p-4 flex items-center justify-between border-b border-slate-200/80 ${isCollapsed ? 'flex-col gap-2' : ''}`}>
        {!isCollapsed ? (
          ...
          <div className="w-10 h-10 rounded-md bg-[#1890ff] flex items-center justify-center font-black text-white text-base shadow-2xs" title="Sagacitas E-Learning">
            S
          </div>
        )}
      ...
      <nav className="flex-1 px-2.5 space-y-1 mt-2 overflow-y-auto" id="sidebar-nav">
        ...
        {checkViewPermission('instructor-portfolio') && (
          <button
