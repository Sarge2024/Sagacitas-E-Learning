...
export const ReverseEngineeringView: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Intro Header */}
      <div className="bg-white rounded-md p-6 border border-slate-200 shadow-2xs space-y-3">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-md bg-gradient-to-br from-[#1890ff] to-[#096dd9] flex items-center justify-center text-white font-bold shadow-2xs">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <div className="space-y-2 max-h-[220px] overflow-y-auto pr-1">
                {selectedUcs.map((uc) => (
                  <div key={uc.id} className="p-2.5 bg-slate-50 border border-slate-200 rounded-md flex items-center justify-between text-xs">
                    <div>
            ...
            <button
              ...
              className="w-full py-3 bg-[#1890ff] hover:bg-[#096dd9] text-white font-extrabold text-xs rounded-md shadow-2xs transition-all cursor-pointer flex items-center justify-center gap-2"
            >
        ...
        <div className="bg-white rounded-md p-6 border border-slate-200 space-y-4 shadow-2xs">
          ...
          {generatedCourse ? (
            <div className="space-y-3">
              ...
              <div className="space-y-2 max-h-[180px] overflow-y-auto pr-1">
                {generatedCourse.modules?.map((mod) => (
                  <div key={mod.id} className="p-2.5 bg-slate-50 border border-slate-200 rounded-md text-xs space-y-1">
              ...
              <button
                ...
                className="w-full py-3 bg-slate-900 hover:bg-slate-800 text-white font-extrabold text-xs rounded-md shadow-2xs transition-all cursor-pointer flex items-center justify-center gap-2"
              >
            ...
            <div className="p-8 text-center bg-slate-50 rounded-md border border-dashed border-slate-300 text-slate-400 text-xs">
        ...
        <div className="bg-white rounded-md p-6 border border-slate-200 space-y-4 shadow-2xs">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-xs rounded-md transition-all cursor-pointer flex items-center gap-2 shadow-2xs"
            >
          ...
          <div className="p-4 bg-slate-50 border border-slate-200 rounded-md max-h-[350px] overflow-y-auto">
            <iframe
